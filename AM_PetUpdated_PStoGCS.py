...
class CustomPipelineOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls, parser):
        parser.add_value_provider_argument(
            ...
            default = 'prd-analytics-data-lake/Accounts/PetUpdated/PetUpdated_testing.json')
        parser.add_value_provider_argument(
            '--output',
            type=str,
...
def streaming_pipeline(project, region="us-central1"):
    ...
    subscription = "projects/furlong-platform-prd-07cbc1/subscriptions/Pet_Updated"
    bucket = "gs://prd-analytics-data-lake/Accounts/PetUpdated/"
    ...
    options = PipelineOptions(
        ...
        template_location = 'gs://prd-analytics-temp-files/Accounts/AM_PetUpdated_PStoGCS.py',
    ...
    class WriteToGCS(beam.DoFn):
        def __init__(self):
            self.outdir = "gs://prd-analytics-data-lake/Accounts/PetUpdated/"
    ...
    subscription = "projects/furlong-platform-prd-07cbc1/subscriptions/Pet_Updated"
    topic = "projects/furlong-platform-prd-07cbc1/topics/pet-updated"
    bucket = "gs://prd-analytics-data-lake/Accounts/PetUpdated/"
