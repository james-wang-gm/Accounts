#Pub/Sub to GCS Account Microservice Pet Updated pipeline
...
class CustomPipelineOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls, parser):
        parser.add_value_provider_argument(
            ...
            default = 'dev-analytics-data-lake/Accounts/PetUpdated/PetUpdated_testing.json')
        parser.add_value_provider_argument(
            '--output',
            type=str,
...
def streaming_pipeline(project, region="us-central1"):
    ...
    subscription = "projects/furlong-platform-sbx-8d14f3/subscriptions/Pet_Updated"
    bucket = "gs://dev-analytics-data-lake/Accounts/PetUpdated/"
    ...
    options = PipelineOptions(
        ...
        template_location = 'gs://dev-analytics-temp-files/Accounts/AM_PetUpdated_PStoGCS.py',
    ...
    class WriteToGCS(beam.DoFn):
        def __init__(self):
            self.outdir = "gs://dev-analytics-data-lake/Accounts/PetUpdated/"
        ...
        def process(self, element):
            ...
            file_prefix = "Pet_Updated_Output_" + timestampStr + '.json' 
            writer = FileSystems.create(self.outdir + file_prefix, 'text/plain')
            writer.write(element.encode())
            writer.close()

    subscription = "projects/furlong-platform-sbx-8d14f3/subscriptions/Pet_Updated"
    topic = "projects/furlong-platform-sbx-8d14f3/topics/pet-updated"
    bucket = "gs://dev-analytics-data-lake/Accounts/PetUpdated/"
